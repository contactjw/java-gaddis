...
// All other code besides copy constructor belongs to Tony Gaddis.
public class BankAccount
{
   ...
   */
   ...
   // This is the code for the practice problem.
   public BankAccount(BankAccount copyBank) {
	   this.balance = copyBank.balance;
   }
